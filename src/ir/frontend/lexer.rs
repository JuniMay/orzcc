    ...
    T: io::Read,
{
    ...
    fn handle_symbol(&mut self) -> Option<Token> {
        ...
        let token = Some(match self.curr_char.unwrap() {
            '(' => Token::new(span, TokenKind::Other("(".to_string())),
            ')' => Token::new(span, TokenKind::Other(")".to_string())),
            '{' => Token::new(span, TokenKind::Other("{".to_string())),
            '}' => Token::new(span, TokenKind::Other("}".to_string())),
            ',' => Token::new(span, TokenKind::Other(",".to_string())),
...
"#,
        ...
        let expected_tokens = vec![
            ...
            TokenKind::Other("=".to_string()),
            TokenKind::Keyword(Keyword::Int(32)),
            TokenKind::Bytes(vec![16, 16, 16, 16, 0, 0, 0, 0]),
            TokenKind::Keyword(Keyword::Const),
            TokenKind::GlobalIdent("@y".to_string()),
            TokenKind::Other("=".to_string()),
            TokenKind::Keyword(Keyword::Int(32)),
            TokenKind::Bytes(vec![32, 32, 32, 32, 0, 0, 0, 0]),
            ...
            TokenKind::Keyword(Keyword::Int(32)),
            TokenKind::Other(";".to_string()),
            TokenKind::Bytes(vec![3, 0, 0, 0, 0, 0, 0, 0]),
            TokenKind::Other("]".to_string()),
            TokenKind::Other("[".to_string()),
            TokenKind::Bytes(vec![1, 0, 0, 0, 0, 0, 0, 0]),
            TokenKind::Other(",".to_string()),
            TokenKind::Bytes(vec![2, 0, 0, 0, 0, 0, 0, 0]),
            TokenKind::Other(",".to_string()),
            TokenKind::Bytes(vec![3, 0, 0, 0, 0, 0, 0, 0]),
            TokenKind::Other("]".to_string()),
            TokenKind::Keyword(Keyword::Fn),
            ...
            TokenKind::Other(",".to_string()),
            TokenKind::Keyword(Keyword::Int(32)),
            TokenKind::Bytes(vec![210, 4, 0, 0, 0, 0, 0, 0]),
