...
pub struct MachineFunctionData {
    ...
    /// The saved registers of this function.
    ///
    /// This will be generated by the register allocator.
    saved_regs: HashSet<Register>,
}
...
impl MachineFunctionData {
    ...
    fn calculate_alignment(&mut self) {
        // align to 16 bytes
    ...
    /// Get the additional size for alignment.
    pub fn align(&self) -> Option<usize> { self.stack_align }

    pub fn add_saved_reg(&mut self, reg: Register) { self.saved_regs.insert(reg); }

    pub fn saved_regs(&self) -> &HashSet<Register> { &self.saved_regs }
}
...
impl Register {
    ...
    pub fn is_gp(&self) -> bool { matches!(self, Register::General(_)) }

    pub fn is_fp(&self) -> bool { matches!(self, Register::FloatingPoint(_)) }
}
